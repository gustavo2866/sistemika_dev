        ...
        <div className="relative hidden h-full flex-col bg-muted p-10 text-white dark:border-r lg:flex">
          ...
          <div className="relative z-20 mt-auto">
            <blockquote className="space-y-2">
              <p className="text-lg">
                &ldquo;Shadcn Admin Kit nos ha permitido crear rápidamente una
                herramienta poderosa que de otra manera habría tomado meses de
                tiempo y esfuerzo desarrollar.&rdquo;
              </p>
