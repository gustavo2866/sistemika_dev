...
class Contrato(Base, table=True):
    ...
    # --- Estado ---
    estado: str = Field(default="borrador", max_length=50, index=True, description="Estado del contrato: borrador|vigente|vencido|rescindido|renovado")
    ...
    contrato_renovado_id: Optional[int] = Field(default=None, foreign_key="contratos.id", description="ID del nuevo contrato (cuando estado=renovado)")
