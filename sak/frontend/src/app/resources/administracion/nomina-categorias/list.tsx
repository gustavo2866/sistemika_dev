...
export const NominaCategoriaList = ({
  embedded = false,
  rowClick = "edit",
  perPage = 25,
  createTo,
}: NominaCategoriaListProps = {}) => (
  <List
    resource="nomina-categorias"
    title="Categorias de nomina"
    filters={LIST_FILTERS}
...
export default NominaCategoriaList;
