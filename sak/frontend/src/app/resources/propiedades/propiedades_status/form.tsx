...
import {
  propiedadesStatusSchema,
  PROPIEDADES_STATUS_DEFAULT,
  VALIDATION_RULES,
  type PropiedadesStatusFormValues,
} from "./model";

const PropiedadesStatusMainFields = () => (
...
export const PropiedadesStatusForm = () => (
  <SimpleForm<PropiedadesStatusFormValues>
    className="w-full max-w-2xl"
    resolver={zodResolver(propiedadesStatusSchema) as any}
    toolbar={<FormOrderToolbar />}
    defaultValues={PROPIEDADES_STATUS_DEFAULT}
  >
    <SectionBaseTemplate
      title="Datos del estado"
      main={<PropiedadesStatusMainFields />}
      defaultOpen
    />
  </SimpleForm>
);
