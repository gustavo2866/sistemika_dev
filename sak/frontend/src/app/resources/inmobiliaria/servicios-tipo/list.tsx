...
export const ServicioTipoList = ({
  ...
  >
    ...
    >
      ...
      <ListColumn source="url" label="URL" className="w-[280px]">
        <ListText source="url" className="whitespace-normal break-words" />
      </ListColumn>
