...
export const CRMOportunidadPanelForm = () => {
  ...
  return (
    <div className="w-full max-w-4xl mr-auto ml-0">
      <SimpleForm
        ...
        toolbar={<FormToolbar className="mt-4 rounded-2xl border border-border/50 bg-background/80 p-3 shadow-sm" />}
      >
...
const OportunidadFormSections = () => {
  ...
  return (
    <Card className="flex w-full flex-col gap-6 rounded-[30px] border border-border/40 bg-gradient-to-b from-background to-muted/10 p-4 shadow-lg">
