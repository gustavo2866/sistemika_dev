/**
 * Modelo de dominio para Estados de Factura de Compra (PO)
 */
...
export const poInvoiceStatusSchema = z.object({
...
export type PoInvoiceStatusFormValues = z.infer<typeof poInvoiceStatusSchema>;

export const PO_INVOICE_STATUS_DEFAULT: PoInvoiceStatusFormValues = {
  nombre: "",
  descripcion: "",
  orden: 1,
  activo: true,
