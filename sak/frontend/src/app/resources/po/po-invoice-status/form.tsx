...
import {
  poInvoiceStatusSchema,
  PO_INVOICE_STATUS_DEFAULT,
  VALIDATION_RULES,
  type PoInvoiceStatusFormValues,
} from "./model";

const PoInvoiceStatusMainFields = () => (
...
export const PoInvoiceStatusForm = () => (
  <SimpleForm<PoInvoiceStatusFormValues>
    className="w-full max-w-2xl"
    resolver={zodResolver(poInvoiceStatusSchema) as any}
    toolbar={<FormOrderToolbar />}
    defaultValues={PO_INVOICE_STATUS_DEFAULT}
  >
    <SectionBaseTemplate
      title="Datos del estado"
      main={<PoInvoiceStatusMainFields />}
      defaultOpen
    />
  </SimpleForm>
);
