/**
 * Modelo de dominio para Estados Financieros de Factura de Compra (PO)
 */
...
export type PoInvoiceStatusFin = {
  id: number;
  nombre: string;
...
export const poInvoiceStatusFinSchema = z.object({
...
export type PoInvoiceStatusFinFormValues = z.infer<typeof poInvoiceStatusFinSchema>;

export const PO_INVOICE_STATUS_FIN_DEFAULT: PoInvoiceStatusFinFormValues = {
  nombre: "",
  descripcion: "",
  orden: 1,
  activo: true,
