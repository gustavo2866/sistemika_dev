...
export const DashboardMainPanel = ({
  ...
  <div className="flex flex-col gap-3">
    <div className="flex flex-col gap-3 lg:grid lg:grid-cols-[minmax(0,7fr)_minmax(280px,3fr)] lg:items-start">
    ...
    <div className="grid gap-3 lg:grid-cols-[minmax(0,7fr)_minmax(280px,3fr)] lg:items-start">
