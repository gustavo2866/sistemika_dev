...
export const TarjaEstadoList = ({
  embedded = false,
  rowClick = "edit",
  perPage = 25,
  createTo,
}: TarjaEstadoListProps = {}) => (
  <List
    resource="tarja-estados"
    title="Estados de tarja"
    filters={LIST_FILTERS}
...
export default TarjaEstadoList;
