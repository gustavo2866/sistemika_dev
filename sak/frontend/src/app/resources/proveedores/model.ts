...
export const PROVEEDOR_DEFAULT: Partial<ProveedorFormValues> = {
  ...
  tipo_comprobante_id: undefined,
  dias_vencimiento: undefined,
  default_tipo_solicitud_id: undefined,
  default_departamento_id: undefined,
  default_metodo_pago_id: undefined,
  default_usuario_responsable_id: undefined,
  default_articulos_id: undefined,
  activo: true,
};
