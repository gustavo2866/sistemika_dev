  ...
  [
    {
      ...
      props: {
        source: "q",
        label: "Buscar",
        placeholder: "Buscar origenes de lead",
        alwaysOn: true,
...
// Renderiza la grilla principal del catalogo de origenes de lead.
export const CRMOrigenLeadList = ({
  embedded = false,
}: CRMOrigenLeadListProps) => (
  <List
    title="CRM - Origenes de Lead"
    filters={listFilters}
    actions={<CRMOrigenLeadListActions />}
    debounce={300}
    perPage={25}
