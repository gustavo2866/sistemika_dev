  ...
  [
    {
      ...
      props: {
        source: "q",
        label: "Buscar",
        placeholder: "Buscar motivos de evento",
        alwaysOn: true,
...
const CRMMotivoEventoListActions = ({
...
// Renderiza la grilla principal del catalogo de motivos de evento.
export const CRMMotivoEventoList = ({
  ...
  <List
    ...
    filters={listFilters}
    actions={
      <CRMMotivoEventoListActions embedded={embedded} createTo={createTo} />
    }
    debounce={300}
    perPage={25}
