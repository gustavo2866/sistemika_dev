...
export const CRMChatList = () => {
  ...
  return (
    <div className="mr-auto flex h-[calc(100dvh-88px)] max-h-[680px] w-full max-w-xl flex-col gap-3 overflow-hidden bg-[#f6f2e8] px-2 pb-3 pt-3 sm:px-6 lg:h-[calc(100dvh-112px)]">
      ...
      <div className="min-h-0 flex-1 overflow-hidden rounded-2xl border border-slate-200/70 bg-white/95 shadow-sm">
        {loading ? (
          ...
          <div
            ref={listViewportRef}
            className="h-full overflow-y-scroll overscroll-y-contain [scrollbar-gutter:stable]"
