...
import { formatCurrency, type CrmDashboardDetalleItem } from "../../model";
import { saveDashboardReturnMarker } from "../../return-state";
import type { DashboardDetailItem } from "./use-dashboard-main-panel";
...
export const CrmOpportunitiesDetailTable = ({
  detailItems,
}: {
...
export const buildCrmOpportunitiesDetailTitle = (title: string) => (
