...
import { ArrowLeft, BarChart3, ChartNoAxesCombined, Handshake, RefreshCcw } from "lucide-react";
...
const HeaderActions = ({
  ...
  return (
    <div className="flex items-center gap-1">
      ...
      >
        <RefreshCcw className={`h-3 w-3 sm:h-3.5 sm:w-3.5 ${dashboardLoading ? "animate-spin" : ""}`} />
      </Button>
    </div>
  );
};
