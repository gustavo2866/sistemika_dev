...
export type CrmDashboardReturnMarker = {
  savedAt: number;
...
export const saveDashboardReturnMarker = (
  returnTo: string,
  marker: CrmDashboardReturnMarker,
) => {
...
export const loadDashboardReturnMarker = (
  ...
  try {
    const parsed = JSON.parse(raw) as CrmDashboardReturnMarker;
