...
export const ResponsiveDetailRow = forwardRef<HTMLDivElement, ResponsiveDetailRowProps>(
  ({ className, children, ...props }, ref) => {
    return (
      ...
      >
        <div
          data-detail-edit-hint
          className="pointer-events-none absolute right-1 top-1/2 hidden -translate-y-1/2 items-center text-muted-foreground/70 opacity-0 transition-opacity group-hover:opacity-100 group-[.is-active]:opacity-0 sm:flex"
        >
